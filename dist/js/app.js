(() => {
    ...
    class ScrollWatcher {
        ...
        scrollWatcherConstructor(items) {
            ...
            } else this.scrollWatcherLogging("Сплю, немає об'єктів для стеження/");
        }
    ...
    let fileType = "png";
    for (const tab in tabLinks) if (Object.hasOwnProperty.call(tabLinks, tab)) tabLinks[tab].addEventListener("click", (e => {
